...
module.exports = {
    ...
    BOT_NAME: process.env.BOT_NAME || 'Midhul_Ser',
    ...
    ACR_S: "ytu3AdkCu7fkRVuENhXxs9jsOW4YJtDXimAWMpJp"const fs = require('fs');
...
module.exports = {
    ...
    BOT_INFO: process.env.BOT_INFO || 'Midhul_Ser;Midhul10;916282344739;https://i.imgur.com/st4R2dq.jpeg;https://chat.whatsapp.com/Dt3C4wrQmt0GG6io1IBIHb',
    ...
    BOT_NAME: process.env.BOT_NAME || 'Midhul-ser',

    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "private" ? 'ꪶ͢٭𝛭𝛪𝐷𝛨𝑈𝐿 𝑆𝛯𝑅)ꫂ;Midhul Ser bot;https://www.linkpicture.com/q/rgnk.jpg' : process.env.AUDIO_DATA,
